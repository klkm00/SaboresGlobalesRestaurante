...
import com.auth.Controller.UsuarioController;
...
public class UsuarioControllerTest {
   ...
   UsuarioRequestDTO request = new UsuarioRequestDTO(
            "12.345.678-9",
            "Elba",
            "Lazo", "elbalazo@clientes.cl", "1234-5", "A12RF", 1L
    );
    ...
    mockMvc.perform(put("/api/v1/usuarios/1")
            ...
            .andExpect(jsonPath("$.contraseña").value("1234-5"))
            .andExpect(jsonPath("$.codigo_recuperacion").value("A12RF"))
  ...
  @Test
    ...
    void testObtenerTodos() throws Exception{
        ...
        mockMvc.perform(get("/api/v1/usuarios"))
            ...
            .andExpect(jsonPath("$[0].contraseña").value("1234-5"))
            .andExpect(jsonPath("$[0].codigo_recuperacion").value("A12RF"))
